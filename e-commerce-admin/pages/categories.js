...
function Categories({ swal }) {
    ...
    function handlePropertyNamaChange(index, property, newName) {
        setProperties(prev => {
    ...
    return (
        <Layout>
            ...
            <form onSubmit={save} className="gap-1">
                    ...
                    {properties.length > 0 && properties.map((property, index) => (
                        <div className="flex gap-1 mb-2">
                            <input
                                type="text"
                                className="mb-0"
                                onChange={ev => handlePropertyNamaChange(index, property, ev.target.value)}
                                value={property.name}
